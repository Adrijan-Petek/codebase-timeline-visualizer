...
class GitAnalyzer:
    ...
    def get_contributor_stats(self, commits: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for commit in commits:
            ...
            contributors[author]['first_commit'] = min(contributors[author]['first_commit'], commit['timestamp'])
            contributors[author]['last_commit'] = max(contributors[author]['last_commit'], commit['timestamp'])
    ...
    def get_file_stats(self, commits: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for commit in commits:
            for file_change in commit['files_changed']:
                ...
                files[filename]['first_change'] = min(files[filename]['first_change'], commit['timestamp'])
                files[filename]['last_change'] = max(files[filename]['last_change'], commit['timestamp'])
